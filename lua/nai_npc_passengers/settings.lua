...
NPCPassengers.Version = NPCPassengers.Version or "306"
NPCPassengers.BuildDate = NPCPassengers.BuildDate or "2026-05-16"
...
NPCPassengers.cv_die_with_vehicle = CreateConVar("nai_npc_die_with_vehicle", "1", {FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Kill all NPC passengers when their vehicle is destroyed/explodes")
...
-- Taxi settings
NPCPassengers.cv_taxi_enabled = CreateConVar("nai_npc_taxi_enabled", "1", {FCVAR_ARCHIVE, FCVAR_REPLICATED}, "Enable NPC taxi system")
