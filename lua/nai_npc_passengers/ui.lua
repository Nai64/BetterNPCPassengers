...
local function OpenSettingsPanel()
    ...
    langBtn.DoClick = function(self)
        ...
        if LanguageExists("vietnamese.lua") then
            menu:AddOption("Tiếng Việt", function()
                self.currentLang = "VN"
        ...
        if LanguageExists("thai.lua") then
            menu:AddOption("ภาษาไทย", function()
                self.currentLang = "TH"
            ...
            end):SetIcon("flags16/th.png")
        end

        if LanguageExists("italian.lua") then
            menu:AddOption("Italiano", function()
                self.currentLang = "IT"
        ...
        if LanguageExists("kyrgyz.lua") then
            menu:AddOption("Кыргыз тили", function()
                self.currentLang = "KG"
        ...
        if LanguageExists("romanian.lua") then
            menu:AddOption("Română", function()
                self.currentLang = "RO"
        ...
        if LanguageExists("hungarian.lua") then
            menu:AddOption("Magyar", function()
                self.currentLang = "HU"
    ...
    CreateButton(debugPanel, L("npcpassengers.ui.test_flinch"), function()
        net.Start("NPCPassengers_DebugTest")
        net.WriteString("flinch")
        net.SendToServer()
    end)
    
    CreateButton(debugPanel, L("npcpassengers.ui.test_random"), function()
        net.Start("NPCPassengers_DebugTest")
        net.WriteString("gesture")
        net.SendToServer()
    end)
    
    CreateButton(debugPanel, L("npcpassengers.ui.reset_states"), function()
        net.Start("NPCPassengers_DebugTest")
        net.WriteString("reset")
        net.SendToServer()
    end)
    ...
    CreateButton(interfacePanel, L("npcpassengers.ui.hide_context"), function()
    ...
    CreateButton(interfacePanel, L("npcpassengers.ui.reset_ui"), function()
