...
print(" ")
print("-----------------Nai's Base----------------------------")
print("It looks like Nai's Base loaded properly.")
print("You can use naibase_kill 1 to completely kill the base if needed.")
print("Downloaded version: 1.0.2a")
print("The source code of the base can be found at https://Nai64.github.io/NaisBase")
print("View documentation at https://Nai64.github.io/NaisBase/docs")
print("Join our discord server for extra help and support: https://discord.gg/Xgh7Asf3")
print("-----------------Nai's Base----------------------------")
print(" ")
print(" ")
print(" ")
