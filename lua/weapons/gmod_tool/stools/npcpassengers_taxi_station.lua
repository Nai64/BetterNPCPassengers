...
function TOOL.BuildCPanel(panel)
    ...
    -- Simple model selection using standard control
    panel:AddControl("ComboBox", {
        Label = "Model",
        Options = {
            ["Combine Barricade"] = { npcpassengers_taxi_station_model = "models/props_combine/combine_barricade_short02a.mdl" },
            ["Concrete Barrier"] = { npcpassengers_taxi_station_model = "models/props_c17/concrete_barrier001a.mdl" },
            ["Lockers"] = { npcpassengers_taxi_station_model = "models/props_c17/lockers.mdl" },
            ["Truss"] = { npcpassengers_taxi_station_model = "models/props_c17/truss01a.mdl" },
            ["Traffic Cone"] = { npcpassengers_taxi_station_model = "models/props_junk/trafficcone001a.mdl" }
        }
    })
