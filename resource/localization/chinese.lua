...
-- TRANSLATORS: Replace the English text after each language.Add() with Chinese translations
-- This is a template - fill in the Chinese translations
...
print("[Better NPC Passengers] Chinese localization template loaded - needs translation!")
